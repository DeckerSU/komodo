...
public:
    ...
    void AvailableCoinsFast(std::vector<COutput>& vCoins, bool fOnlyConfirmed=true, const CCoinControl *coinControl = NULL, bool fIncludeZeroValue=false, bool fIncludeCoinBase=true, const int nMinDepth = 0, const int nMaxDepth = 9999999) const;
